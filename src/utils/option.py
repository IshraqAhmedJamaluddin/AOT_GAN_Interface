...
parser.add_argument('--data_train', type=str, default='clear',
                    help='dataname used for training')
parser.add_argument('--data_noise', type=str, default='noise3',
                    help='dataname used for training')
...
# parser.add_argument('--rates', type=str, default='2+4+8+16',
#                     help='dilation rates used in AOT block')
...
parser.add_argument('--save_dir', type=str, default='experiments/Kernal_3',
...
# ----------------------------------
# converts for example --painter to parameters to be called args 
args = parser.parse_args()
print(args.dir_image)
args.iterations = int(args.iterations)
print("args.iteration =",args.iterations)
